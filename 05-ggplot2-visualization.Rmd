# Ggplot2可视化 {#ggplot2-visualization}
...
unemp <- read.csv(file = "http://datasets.flowingdata.com/unemployment09.csv", 
...
ggplot(choropleth, aes(long, lat, group = group)) +
  ...
  labs(fill = "ratio of unemployment",title = "unemployment by county, 2009",
