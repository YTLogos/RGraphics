...
Nice Bar Graph from Data Visualisation with R: 100 Examples
https://rpubs.com/chidungkt/392980
...
[Lemniscate of Bernoulli](https://www.wikiwand.com/en/Lemniscate_of_Bernoulli) 双纽线

```r
x = a*sqrt(2*cos(2*theta))*cos(theta)
y = a*sqrt(2*cos(2*theta))*sin(theta)
theta = -pi/4 pi/4 
theta = 3/4*pi 5/4*pi
```
