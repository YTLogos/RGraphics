...
[Handling Strings with R](https://www.gastonsanchez.com/r4strings/) 和 [Text Mining with R A Tidy Approach](https://www.tidytextmining.com/) 字符串入门介绍 [R for Data Science](https://r4ds.had.co.nz/strings.html)， 谢士晨整理了 stringr 包与 Base R 正则表达式函数的对应表 <http://shichen.name/post/2017/07/25/datamani/>
