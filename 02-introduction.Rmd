...
选择来自 rocker 项目的 Docker 镜像来构建书籍，使用的镜像是 `rocker/verse`
...
在本地拉取了一个名叫 rstudio 的镜像，从虚拟机到宿主机的映射端口是，8787 端口是虚拟机中 RStudio IDE 默认占用的，这样就可以在宿主机的浏览器里打开链接 <http://localhost:8585>
