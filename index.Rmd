...
* 主页
  ...
  - [边蓓蕾](http://statsjoke.me)
  - [郎大为](http://langdawei.com/)
  - [寇强](http://qkou.info/)
  - [邱怡轩](https://yixuan.cos.name/cn/) or [Yixuan Qiu-en](https://statr.me/)
  - [杨洵默](https://tcya.xyz/)
  - [杜亚蕾](http://yalei.name/)
...
Running under: Ubuntu 16.04.5 LTS, RStudio 1.1.463
...
Package version:
  base64enc_0.1.3  bookdown_0.9     colorspace_1.4.0 digest_0.6.18    evaluate_0.12   
  filehash_2.4.1   fontcm_1.1       glue_1.3.0       graphics_3.4.4   grDevices_3.4.4 
  highr_0.7        htmltools_0.3.6  jsonlite_1.6     knitr_1.21       magrittr_1.5    
  markdown_0.9     methods_3.4.4    mime_0.6         png_0.1.7        Rcpp_1.0.0      
  rmarkdown_1.11   stats_3.4.4      stringi_1.2.4    stringr_1.3.1    tikzDevice_0.12 
  tinytex_0.10     tools_3.4.4      utils_3.4.4      xfun_0.4         yaml_2.2.0      
