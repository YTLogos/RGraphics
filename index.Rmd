...
```{r anscombe-regression,out.width="65%",fig.width=5.5,fig.asp=1,fig.cap="Anscombe's 4 Regression data sets",echo=FALSE}
data(anscombe)
...
for (i in seq(4)) {
  ...
  mtext(substitute(x[i], list(i = i)), 1, line = 3)
  mtext(substitute(y[i], list(i = i)), 2, line = 3)
