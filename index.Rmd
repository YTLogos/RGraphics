...
packages = c(
  ...
  "tikzDevice", "fontcm", "microbenchmark", "rsconnect",
  "sp", "maptools", "maps", "mapdata", "mapproj", "DAAG",
  "ggplot2", "devtools", "sf", "rgdal", "fs", "tidyverse",
  "DBI", "odbc", "tm"
)
...
1. 字符串处理与正则表达式，用以提取
1. 动手学习 Python，搞明白 MemectExtractor 提取工具
1. 自然语言处理与 Python 实现
1. 一天一个 R 函数介绍，从正则表达式开始
:::
...
热心开源事业，目前在统计之都理事、副主编 Associated Editor of Captial of Statistics 
...
sessionInfo(package = c(
  "colorspace", "magrittr", "bookdown", "rmarkdown",
  "tikzDevice", "fontcm", "fs", "tidyverse",
  "sp", "maptools", "maps", "mapdata", "mapproj",
  "ggplot2", "devtools", "sf", "rgdal", "grid"
))
```
