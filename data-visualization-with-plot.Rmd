...
```{r,echo=TRUE,fig.cap="不同的 pch 参数值",title.mar=TRUE}
...
```{r,echo=TRUE,fig.cap="pch 支持的字符",out.width="35%",title.mar=TRUE}
...
```{r pos,fig.cap="pos 位置参数",echo=TRUE,out.width="35%",fig.asp=1,title.mar=TRUE}
y <- x <- 1:4
