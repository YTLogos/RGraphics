...
```{r,fig.cap="区域重叠 polygon 函数",echo=TRUE}
...
```{r pos,fig.cap="pos 位置参数",echo=TRUE,out.width="45%",fig.asp=1,fig.width=4.5,title.mar=TRUE}
y <- x <- 1:4
...
```{r gap-axis,fig.asp=1,fig.cap="gap.axis用法",echo=TRUE,title.mar=TRUE}
