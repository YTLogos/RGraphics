...
```{tikz demo-tikz, fig.cap='tikz 图形',eval=identical(.Platform$OS.type,'unix')}
...
```{tikz complicated-tikz, fig.cap='稍复杂的 tikz 图形',eval=identical(.Platform$OS.type,'unix')}
...
```{r linear-model,dev='tikz',fig.cap="线性回归模型",out.width="35%",fig.asp=1,fig.width=3.5,tikz2png='-quality 100 -density 300',fig.process=to_png,eval=identical(.Platform$OS.type,'unix'),echo=TRUE}
# 带有图标题
