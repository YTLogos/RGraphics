...
```{r linear-model,dev='tikz',fig.cap="线性回归模型",out.width="35%",fig.asp=1,fig.width=3.5,tikz2png='-quiet -quality 100 -density 300',fig.process=to_png,echo=TRUE,eval=identical(.Platform$OS.type,'unix')}
# 带有图标题
