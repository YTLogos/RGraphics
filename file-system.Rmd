...
rtools_path <- paste("C:/Rtools/mingw_64/bin",
  "C:/Rtools/mingw_32/bin",
  sep = .Platform$path.sep
)
if (.Platform$OS.type == "windows") { # use conda env
  Sys.setenv(PATH = paste(
    rtools_path, Sys.getenv("PATH"),
    sep = .Platform$path.sep
  ))
}
```
...
1. 查询 R 包的依赖关系
    ...
    ```{r,echo=TRUE,eval=require('rmarkdown')}
    # rmarkdown 依赖的 R 包
